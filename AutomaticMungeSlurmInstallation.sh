...
# similar as master node but we don't install slurm database and slurm controller daemon 		
  ...
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-perlapi-17.11.7-1.el7.x86_64.rpm  
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-contribs-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-devel-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-example-configs-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-libpmi-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-openlava-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-pam_slurm-17.11.7-1.el7.x86_64.rpm
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-slurmd-17.11.7-1.el7.x86_64.rpm  
  ssh root@192.168.70.$i yum install -y slurm_rpms/slurm-torque-17.11.7-1.el7.x86_64.rpm
...
# 
# COMPUTE NODES
NodeName=node1 NodeAddr=192.168.70.212 CPUs=8 Sockets=1 CoresPerSocket=4 ThreadsPerCore=2 State=UNKNOWN
NodeName=node2 NodeAddr=192.168.70.213 CPUs=4 Sockets=1 CoresPerSocket=2 ThreadsPerCore=2 State=UNKNOWN
NodeName=toklap124 NodeAddr=192.168.70.214 CPUs=4 Sockets=1 CoresPerSocket=2 ThreadsPerCore=2 State=UNKNOWN
PartitionName=production Nodes=node[1-2] Default=YES MaxTime=INFINITE State=UP
PartitionName=debug Nodes=toklap124 Default=YES MaxTime=INFINITE State=UP
EOF
